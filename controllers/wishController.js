...
module.exports = function(app){
 ...
 nodemailer.createTestAccount((err, account) => {
    ...
    let transporter = nodemailer.createTransport({
        ...
        auth: {
            user: 'ceo@jabkadev.com', // generated ethereal user
            pass: 'M4Forever' // generated ethereal password
        },
         tls: {
    ...
    let mailOptions = {
        from: '" WantIT " <ceo@jabkadev.com>', // sender address
        to: email, // list of receivers
        subject: 'Появилось желание в вашей группе', // Subject line
        text: req.session.User+' теперь хочет '+wish, // plain text body
        html: '<b>'+req.session.User+' теперь хочет '+wish+'</b>' // html body
    };
